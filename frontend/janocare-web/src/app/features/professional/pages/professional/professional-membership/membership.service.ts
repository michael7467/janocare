...
import { ProfessionalInfoService, ProfessionalMembership, ProfessionalMembershipService, cleanObject } from '../../../../../core';
...
export class MembershipService {
  private _data$ = new BehaviorSubject<ProfessionalMembership[]>([]);
  ...
  constructor(private _baseService: ProfessionalMembershipService) { }
 ...
 public getBaseData() {
  ...
  get membershipName() {
    return this._option.membershipName;
  }
  set membershipName(membershipName: string) {
    membershipName ? (this._option.membershipName = membershipName) : this._set({ membershipName });
  }
