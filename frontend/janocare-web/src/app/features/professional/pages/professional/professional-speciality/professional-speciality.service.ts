...
import {
  ...
  ProfessionalMembershipService,
  ProfessionalService,
  ProfessionalServiceService,
  ProfessionalSpecialization,
  ProfessionalSpecializationService,
  cleanObject,
} from '../../../../../core';
...
export class SpecialityService {
  private _data$ = new BehaviorSubject<ProfessionalSpecialization[]>([]);
  ...
  constructor(private _baseService: ProfessionalSpecializationService) {}
  ...
  get specializationsId() {
    return this._option.specializationsId;
  }
  set specializationsId(specializationsId: string) {
    specializationsId ? (this._option.specializationsId = specializationsId) : this._set({ specializationsId });
  }
}
