...
import { ProfessionalInfoService, ProfessionalMembership, ProfessionalMembershipService, ProfessionalService, ProfessionalServiceService, cleanObject } from '../../../core';
...
export class ServiceService {
  private _data$ = new BehaviorSubject<ProfessionalService[]>([]);
  ...
  constructor(private _baseService: ProfessionalServiceService) { }
  ...
  get serviceName() {
    return this._option.serviceName;
  }
  set serviceName(serviceName: string) {
    serviceName ? (this._option.serviceName = serviceName) : this._set({ serviceName });
  }
  get professionalId() {
